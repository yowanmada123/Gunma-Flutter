...
class ListInternbyPaidProvider extends ChangeNotifier{

  getRecommendedSpaces() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    // print("TOKEN : " + prefs.getString('login').toString()); 

    var isPaid = prefs.getString('isPaid').toString();

    var result = await http.get(Uri.parse("https://api.gunma.my.id/api/v1/internship/isPaid/" + isPaid),
    ...
    print("Ini isPaid Kamu : " + isPaid);
    print("OH YEAH LIST BY Paid DONE");
