...
class ListInternbyLocationProvider extends ChangeNotifier{
  ...
  getRecommendedSpaces() async{
    ...
    var result = await http.get(Uri.parse("https://api.gunma.my.id/api/v1/internship/location/" + location),
    ...
    print("Ini Numb Location Kamu : " + location);
    print("AUOUOUOUOUUO");
